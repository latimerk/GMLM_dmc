...
%% parse data
[GMLMstructure, trials] = DMC.modelBuilder.constructGMLMRegressors(Neurons, TaskInfo, stimulus_config, 'timeBeforeSample_bins', timeBeforeSample, 'timeAfterTestOrResponse_bins', timeAfterTestOrResponse, 'bases', bases);
...
[prior_function_stim, prior_function_response, prior_function_spkHist, prior_function_glmComplete, responsePrior_setup, spkHistPrior_setup] = DMC.modelBuilder.setupPriorFunctions(stimPrior_setup, bases);

...
PYBIND11_MODULE(pyGMLMcuda, m) {
    ...
    py::class_<kCUDA::kcGLM_trial<double>, std::shared_ptr<kCUDA::kcGLM_trial<double>>>(m, "kcGLM_trial")
        .def(py::init<unsigned int, py::array_t<double, py::array::f_style | py::array::forcecast>, py::array_t<double, py::array::f_style | py::array::forcecast> >(),  R"mydelimiter(
    ...
    py::class_<kCUDA::kcGLM_trialBlock<double>, std::shared_ptr<kCUDA::kcGLM_trialBlock<double>>>(m, "kcGLM_trialBlock")
        ...
        .def("addTrial", &kCUDA::kcGLM_trialBlock<double>::addTrial,  R"mydelimiter(
    ...
    py::class_<kCUDA::kcGLM_python<double>>(m, "kcGLM")
        ...
        .def("addBlock", &kCUDA::kcGLM_python<double>::addBlock, R"mydelimiter(
        ...
        .def("isOnGPU", &kCUDA::kcGLM_python<double>::isOnGPU, R"mydelimiter(
            If the variables are loaded to the GPU or not.

            Returns:
              (bool) True or false if on GPU(s).
        )mydelimiter")
        .def("freeGPU", &kCUDA::kcGLM_python<double>::freeGPU, R"mydelimiter(
            Frees all values loaded to the GPU(s).
        )mydelimiter")
        .def("toGPU", &kCUDA::kcGLM_python<double>::toGPU, R"mydelimiter(
            Loads all the trial blocks that have been added to the GPU.
        )mydelimiter")
        .def("computeLogLikelihood", &kCUDA::kcGLM_python<double>::computeLogLikelihood, R"mydelimiter(
        ...
        .def("computeLogLikelihood_grad", &kCUDA::kcGLM_python<double>::computeLogLikelihood_grad, R"mydelimiter(
        ...
        .def("computeLogLikelihood_hess", &kCUDA::kcGLM_python<double>::computeLogLikelihood_hess, R"mydelimiter(
    ...
    py::class_<kCUDA::GPUGMLM_group_structure_python<double>, std::shared_ptr<kCUDA::GPUGMLM_group_structure_python<double>>>(m, "kcGMLM_modelStructure_tensorGroup")
        ...
        .def("setSharedRegressors", &kCUDA::GPUGMLM_group_structure_python<double>::setSharedRegressors,  R"mydelimiter(
        ...
        .def("isSharedRegressor", &kCUDA::GPUGMLM_group_structure_python<double>::isSharedRegressor,  R"mydelimiter(
        ...
        .def("getDimA", &kCUDA::GPUGMLM_group_structure_python<double>::getDimA,  R"mydelimiter(
            Gets the specified number of 'events' this group contributes to.

            Returns:
              dim_A (unsigned int64 : size_t)
        )mydelimiter")
        .def("getFactorDim", &kCUDA::GPUGMLM_group_structure_python<double>::getFactorDim,  R"mydelimiter(
        ...
        .def("getModeDim", &kCUDA::GPUGMLM_group_structure_python<double>::getModeDim,  R"mydelimiter(
        ...
        .def("getSharedRegressorDim", &kCUDA::GPUGMLM_group_structure_python<double>::getSharedRegressorDim,  R"mydelimiter(
        ...
        .def("getNumFactors", &kCUDA::GPUGMLM_group_structure_python<double>::getNumFactors,  R"mydelimiter(
            Gets the number of factors specified

            Returns:
              dim_D (unsigned int64 : size_t): The number of factors. dim_D <= getNumModes()
        )mydelimiter")
        .def("getNumModes", &kCUDA::GPUGMLM_group_structure_python<double>::dim_S,  R"mydelimiter(
    ...
    py::class_<kCUDA::GPUGMLM_structure_python<double>, std::shared_ptr<kCUDA::GPUGMLM_structure_python<double>>>(m, "kcGMLM_modelStructure")
        ...
        .def("addGroup", &kCUDA::GPUGMLM_structure_python<double>::addGroup,  R"mydelimiter(
        ...
        .def("getNumGroups", &kCUDA::GPUGMLM_structure_python<double>::dim_J,  R"mydelimiter( 
            Gets the number of parameter groups that have been added.

            Returns:
              dim_J (unsigned int64: size_t): number of groups
        )mydelimiter")
        .def("getNumNeurons", &kCUDA::GPUGMLM_structure_python<double>::getNumNeurons,  R"mydelimiter( 
            Gets the number of neurons that was specified.

            Returns:
              dim_P (unsigned int64: size_t): number of neurons
        )mydelimiter")
        .def("getNumLinearTerms", &kCUDA::GPUGMLM_structure_python<double>::getNumLinearTerms,  R"mydelimiter( 
        ...
        .def("getGroup", &kCUDA::GPUGMLM_structure_python<double>::getGroup,  R"mydelimiter( 
    ...
    py::class_<kCUDA::GPUGMLM_trialGroup_python<double>, std::shared_ptr<kCUDA::GPUGMLM_trialGroup_python<double>>>(m, "kcGMLM_trial_tensorGroup")
        ...
        .def("addLocalFactor", &kCUDA::GPUGMLM_trialGroup_python<double>::addLocalFactor,  R"mydelimiter(
        ...
        .def("addSharedIdxFactor", &kCUDA::GPUGMLM_trialGroup_python<double>::addSharedIdxFactor,  R"mydelimiter(
        ...
        .def("validDimA", &kCUDA::GPUGMLM_trialGroup_python<double>::validDimA,  R"mydelimiter(
        ...
        .def("getFactorDim", &kCUDA::GPUGMLM_trialGroup_python<double>::getFactorDim,  R"mydelimiter(
        ...
        .def("getDimN", &kCUDA::GPUGMLM_trialGroup_python<double>::getDimN,  R"mydelimiter(
        ...
        .def("getNumFactors", &kCUDA::GPUGMLM_trialGroup_python<double>::getNumFactors,  R"mydelimiter(
    ...
    py::class_<kCUDA::GPUGMLM_trial_python<double>, std::shared_ptr<kCUDA::GPUGMLM_trial_python<double>>>(m, "kcGMLM_trial")
        .def(py::init<py::array_t<double, py::array::f_style | py::array::forcecast>, py::array_t<double, py::array::f_style | py::array::forcecast>, int, int>(),  R"mydelimiter(
        ...
        .def(py::init<py::array_t<double, py::array::f_style | py::array::forcecast>, py::array_t<double, py::array::f_style | py::array::forcecast>, int>(),  R"mydelimiter(
            Object that contains data for a single trial formatted for a GMLM.
        ...
        .def("addGroup", &kCUDA::GPUGMLM_trial_python<double>::addGroup,  R"mydelimiter(
    ...
    py::class_<kCUDA::GPUGMLM_trialBlock_python<double>, std::shared_ptr<kCUDA::GPUGMLM_trialBlock_python<double>>>(m, "kcGMLM_trialBlock")
        .def(py::init<std::shared_ptr<kCUDA::GPUGMLM_structure_python<double>>, unsigned int>(),  R"mydelimiter(
        ...
        .def("addTrial", &kCUDA::GPUGMLM_trialBlock_python<double>::addTrial,  R"mydelimiter(
            Adds a trial of data to the current block.
    ...
    // parameters
     py::class_<kCUDA::GPUGMLM_group_params_python<double>, std::shared_ptr<kCUDA::GPUGMLM_group_params_python<double>>>(m, "kcGMLM_parameters_tensorGroup")
        .def(py::init<std::shared_ptr<kCUDA::GPUGMLM_group_structure_python<double>>, size_t>(),  R"mydelimiter(
        ...
        .def("getRank", &kCUDA::GPUGMLM_group_params_python<double>::getRank,  R"mydelimiter(
            Gets the rank of the tensor.

            Returns:
              dim_R (unsigned int64 : size_t): the rank.
        )mydelimiter") // size_t getRank()
        .def("setRank", &kCUDA::GPUGMLM_group_params_python<double>::setRank,  R"mydelimiter(
        ...
        .def("getDimT", &kCUDA::GPUGMLM_group_params_python<double>::getDimT, R"mydelimiter(
        ...
        .def("getDimS", &kCUDA::GPUGMLM_group_params_python<double>::getDimS, R"mydelimiter(
        ...
        .def("setV", &kCUDA::GPUGMLM_group_params_python<double>::setV,  R"mydelimiter( 
        ...
        .def("setT", &kCUDA::GPUGMLM_group_params_python<double>::setT, R"mydelimiter( 
        ...
        .def("getV", &kCUDA::GPUGMLM_group_params_python<double>::getV,  R"mydelimiter( 
        ...
        .def("getT", &kCUDA::GPUGMLM_group_params_python<double>::getT, R"mydelimiter( 
     ...
     py::class_<kCUDA::GPUGMLM_params_python<double>, std::shared_ptr<kCUDA::GPUGMLM_params_python<double>>>(m, "kcGMLM_parameters")
        .def(py::init<std::shared_ptr<kCUDA::GPUGMLM_structure_python<double>>>(),  R"mydelimiter(
        ...
        .def("getW", &kCUDA::GPUGMLM_params_python<double>::getW,  R"mydelimiter( 
        ...
        .def("getB", &kCUDA::GPUGMLM_params_python<double>::getB,  R"mydelimiter( 
        ...
        .def("getNumGroups", &kCUDA::GPUGMLM_params_python<double>::getNumGroups,  R"mydelimiter( 
        ...
        .def("setLinearParams", &kCUDA::GPUGMLM_params_python<double>::setLinearParams,  R"mydelimiter( 
        ...
        .def("getGroupParams", &kCUDA::GPUGMLM_params_python<double>::getGroupParams,  R"mydelimiter( 
            ...
            Raises:
              value_error: if groupIndex is invalid
        )mydelimiter"); // std::shared_ptr<kCUDA::GPUGMLM_group_structure_python<double> getGroupParams(int group)
    ...
    py::class_<kCUDA::GPUGMLM_group_results_python<double>, std::shared_ptr<kCUDA::GPUGMLM_group_results_python<double>>>(m, "kcGMLM_results_tensorGroup")
        ...
        .def("getRank", &kCUDA::GPUGMLM_group_results_python<double>::getRank,  R"mydelimiter(
            Gets the rank of the tensor.

            Returns:
              dim_R (unsigned int64 : size_t): the rank.
        )mydelimiter") // size_t getRank()
        .def("getDimT", &kCUDA::GPUGMLM_group_results_python<double>::getDimT, R"mydelimiter(
            Gets the dimensions for a tensor mode (excluding the neuron weight mode)
        ...
        .def("getDimS", &kCUDA::GPUGMLM_group_results_python<double>::getDimS, R"mydelimiter(
            Gets the number of tensor modes in the group (excluding the neuron weight mode).

            Returns:
              dim_S (unsigned int64 : size_t): the number of modes.
        )mydelimiter") // size_t getDimS())
        .def("getDV", &kCUDA::GPUGMLM_group_results_python<double>::getDV,  R"mydelimiter( 
        ...
        .def("getDT", &kCUDA::GPUGMLM_group_results_python<double>::getDT, R"mydelimiter( 
     ...
     py::class_<kCUDA::GPUGMLM_results_python<double>, std::shared_ptr<kCUDA::GPUGMLM_results_python<double>>>(m, "kcGMLM_results")
        .def(py::init<std::shared_ptr<kCUDA::GPUGMLM_structure_python<double>>, size_t>(),  R"mydelimiter(
        ...
        .def("getTrialLL", &kCUDA::GPUGMLM_results_python<double>::getTrialLL,  R"mydelimiter( 
        ...
        .def("getDW", &kCUDA::GPUGMLM_results_python<double>::getDW,  R"mydelimiter( 
        ...
        .def("getDB", &kCUDA::GPUGMLM_results_python<double>::getDB,  R"mydelimiter( 
        ...
        .def("getNumGroups", &kCUDA::GPUGMLM_results_python<double>::getNumGroups,  R"mydelimiter( 
            Gets the number of tensor parameter groups in the model.
        ...
        .def("getGroupResults", &kCUDA::GPUGMLM_results_python<double>::getGroupResults,  R"mydelimiter( 
        ...
        )mydelimiter"); // std::shared_ptr<kCUDA::GPUGMLM_group_structure_python<double> getGroupResults(int group)     
    ...
    py::class_<kCUDA::kcGMLM_python<double>>(m, "kcGMLM")
        ...
        .def("addBlock", &kCUDA::kcGMLM_python<double>::addBlock, R"mydelimiter(
        ...
        .def("isOnGPU", &kCUDA::kcGMLM_python<double>::isOnGPU, R"mydelimiter(
            If the variables are loaded to the GPU or not.

            Returns:
              (bool) True or false if on GPU(s).
        )mydelimiter")// bool isOnGPU()
        .def("freeGPU", &kCUDA::kcGMLM_python<double>::freeGPU, R"mydelimiter(
            Frees all values loaded to the GPU(s).
        )mydelimiter")// void freeGPU()
        .def("toGPU", &kCUDA::kcGMLM_python<double>::toGPU, R"mydelimiter(
            Loads all the trial blocks that have been added to the GPU.
        )mydelimiter")// void toGPU()
        .def("computeLogLikelihood", &kCUDA::kcGMLM_python<double>::computeLogLikelihood, R"mydelimiter(
        ...
        )mydelimiter")// std::shared_ptr<kCUDA::GPUGMLM_results_python<double>> computeLogLikelihood(params)

        .def("computeLogLikelihood_async", &kCUDA::kcGMLM_python<double>::computeLogLikelihood_async,  R"mydelimiter(
        ...
        .def("getResults", &kCUDA::kcGMLM_python<double>::getResults,  R"mydelimiter(
            Collects the last computed log likelihood results. This can be called after computeLogLikelihood_async()

            Returns:
              results (pyGMLMcuda.kcGMLM_results): Object containing all the results
        )mydelimiter")// std::shared_ptr<kCUDA::GPUGMLM_results_python<double>> getResults()
        .def("setComputeGradient", &kCUDA::kcGMLM_python<double>::setComputeGradient,R"mydelimiter(
        ...
        .def("getParams", &kCUDA::kcGMLM_python<double>::getParams,  R"mydelimiter(
        ...
        )mydelimiter")// std::shared_ptr<kCUDA::GPUGMLM_results_python<double>> getParams()
        .def("getGMLMStructure", &kCUDA::kcGMLM_python<double>::getGMLMStructure,  R"mydelimiter(

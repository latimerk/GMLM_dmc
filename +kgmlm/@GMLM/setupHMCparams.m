...
%     HMC_settings.M_est.samples       = [4000 19001];
    HMC_settings.M_est.first_sample  = [101 501  1501 5001]; %when to estimate cov matrix. At sample=samples(ii), will use first_sample(samples(ii)):sample
    HMC_settings.M_est.samples       = [500 1000 4000 20001];
